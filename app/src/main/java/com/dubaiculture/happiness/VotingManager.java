...
public class VotingManager {
    ...
    public static void loadHappiness(final WebView webView,final VotingRequest votingRequest, final String secret,  final String serviceProvider, final String clientId,  final String lang) {
