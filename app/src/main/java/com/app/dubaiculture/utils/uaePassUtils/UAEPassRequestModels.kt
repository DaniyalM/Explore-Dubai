package com.app.dubaiculture.utils.uaePassUtils
...
class UAEPassRequestModels {
    ...
    private val SCHEME: String = URI_SCHEME
    private val FAILURE_HOST: String = URI_HOST_FAILURE
    private val SUCCESS_HOST: String = URI_HOST_SUCCESS
